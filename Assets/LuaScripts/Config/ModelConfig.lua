...
ModelConfig[10002]={id=10002,remark='骷髅模型2',path='modelprefabs/Monster_coco',ccHeight=2.6,ccRadius=0.3}
ModelConfig[10003]={id=10003,remark='骷髅模型3',path='modelprefabs/Monster_coco',ccHeight=2.6,ccRadius=0.3}
